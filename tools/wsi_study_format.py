...
COLUMNS = (
    ...
    Column("STAIN_NAME", "Stain Name", "Canonical stain name derived from source metadata.", "STRING", "stain_name"),
    Column("STAIN_GROUP", "Stain Group", "Canonical stain group derived from source metadata.", "STRING", "stain_group"),
